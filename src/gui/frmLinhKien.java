...
public class frmLinhKien extends JPanel implements ActionListener, MouseListener {
	...
	public frmLinhKien() {
		...
		this.linhKienDAO = new LinhKienDAO();
		...
		ArrayList<NhaCungCapLinhKien> dsNCC = this.nhaCungCapDAO.getAllNhaCungCapLinhKien();
		for (NhaCungCapLinhKien nhaCungCapLinhKien : dsNCC) {
			cmbNhaCC.addItem(nhaCungCapLinhKien.getTenNCC());
		}
		...
		ArrayList<DanhMucLinhKien> dsDanhMuc = this.danhMucDAO.getAllDanhMuc();
		for (DanhMucLinhKien danhMucLinhKien : dsDanhMuc) {
			cmbDanhMuc.addItem(danhMucLinhKien.getTenDanhMuc());
		}
	...
	private void DocDuLieuDBVaoTable() {
		ArrayList<LinhKien> dsnv = linhKienDAO.getAllLinhKien();
		for (LinhKien linhKien : dsnv) {
			this.model.addRow(new Object[] {
					linhKien.getMaLinhKien(),
					linhKien.getTenLinhKien(),
					linhKien.getSoLuong(),
					linhKien.getGiaBan(),
					linhKien.getThoiGianBaoHanh(),
					linhKien.getDanhMucLinhKien().getMaDanhMuc(),
					linhKien.getNhaCungCapLinhKien().getMaNhaCungCap(),
					linhKien.getLuotBan(),
					linhKien.getThongSo(),
					linhKien.getNgaySanXuat()
			});
		}
	}
